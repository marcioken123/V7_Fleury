...
uses Windows, SysUtils, Messages, Classes, Graphics, Controls,
  ExtCtrls, Forms, QuickRpt, QRCtrls, CfgGenerica, DB, qrprntr;

type
  TqrSicsCfgGenerica = class(TQuickRep)
    dtlbnd: TQRBand;
    pgheader: TQRBand;
  ...
  public
    class procedure Visualizar(ADataSet: TDataSet; Tipo: TTabelaSics);
  end;

implementation

uses Variants, repPrview,  MyAspFuncoesUteis_VCL;

{$R *.DFM}

{ TqrCfgGenerica }

class procedure TqrSicsCfgGenerica.Visualizar(ADataSet: TDataSet; Tipo: TTabelaSics);
begin
  with TqrSicsCfgGenerica.Create(Application) do
  try
    AjustarQR(Tipo, ADataSet);
