...
uses
  ...
  System.Math;//, {untAspEncode,}{ AspFuncoesUteis};
...
function FieldsValueToChar(const aSQLDataSet: TFDQuery; const aFieldNames: Array of String; const aDefault: Char = CHAR_FALSO): String;
var
  LFieldName: String;
begin
  Result := EmptyStr;
...
function FieldsValueToString(const aSQLDataSet: TFDQuery; const aFieldNames: Array of String; const aDelimiter: String = ';'): String;
var
  LFieldName: String;
begin
  Result := aDelimiter;
...
function FieldsValueToField(const aSQLDataSet: TFDQuery; const aFieldNames: Array of String; const aDelimiter: String = '|'): String;
var
  LFieldName: String;
  LField: TField;
begin
