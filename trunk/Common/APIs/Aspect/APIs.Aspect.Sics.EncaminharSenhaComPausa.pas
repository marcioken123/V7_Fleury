unit APIs.Aspect.Sics.EncaminharSenhaComPausa;
...
type
  ...
  TAPIAspectSicsEncaminharSenhaComPausa = class
  private
  public
...
{$IFDEF CompilarPara_TotemAA}
  TAPIAspectSicsEncaminharSenha.URL := controller.parametros.CarregarParametroStr('APIs.Aspect.Sics', 'URL_EncaminharSenhaComPausa', 'http://10.32.10.21:80/aspect/rest/fila/InserirSenha');
{$ENDIF CompilarPara_TotemAA}
end;

{ TAPIAspectSicsEncaminharSenha }

class function TAPIAspectSicsEncaminharSenhaComPausa.Execute(const AParametrosEntrada: TParametrosEntradaAPI; out AErroAPI: TErroAPI): TTipoRetornoAPI;
var
  LJSON: TJSONObject;
  LRetorno: string;
begin
  TLogSQLite.New(tmInfo, clResponse, 'Consumindo API EncaminharSenhaComPausa').Save;
  TLog.MyLogTemp('Consumindo API EncaminharSenhaComPausa', nil, 0, False, TCriticalLog.tlINFO);
...
{$IFNDEF CompilarPara_TotemAA}
  ...
  try
    TAPIAspectSicsEncaminharSenhaComPausa.URL := ReadString('APIs.Aspect.Sics.EncaminharSenhaComPausa', 'URL', 'http://10.32.10.21:80/aspect/rest/fila/EncaminharComPausa');
    WriteString('APIs.Aspect.Sics.EncaminharSenhaComPausa', 'URL', TAPIAspectSicsEncaminharSenhaComPausa.URL);
  finally
    Free;
  end;
{$ENDIF}
