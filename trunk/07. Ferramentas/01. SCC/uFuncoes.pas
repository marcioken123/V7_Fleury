...
uses
  SysUtils, MyDlls_DR, ClassLibraryVCL, AspectVCL,
  uServicoSCC,
...
//  if GetIsService then
//  begin
//    Result := GetApplicationPath + '\RT-' + srvSCCApp.Name + '\';
//  end
//  else
//  begin
...
begin
  SvcMgr.Application.CreateForm(TsrvSCCApp, srvSCCApp);
  SvcMgr.Application.CreateForm(TMainForm, MainForm);
  //MainForm.InicializarDados;
end;
