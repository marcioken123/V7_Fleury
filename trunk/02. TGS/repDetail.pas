...
type
  TqrSicsDetail = class(TqrSicsDetailBase)
    DetailBand1: TQRBand;
...
uses
  repPrview, Sics_Common_Parametros;

procedure TqrSicsDetail.AlinharLabels;
const
  OFF = 6;
var
...
procedure TqrSicsDetail.DetailReportPreview(Sender: TObject);
begin
  TfrmSicsRepPreview.Preview(Self, TQRPrinter(Sender));
end;

procedure TqrSicsDetail.QRDBText3Print(sender: TObject; var Value: String);
begin
  Value := StrListUnidadesAtds.Values[Value];
end;

procedure TqrSicsDetail.QRDBText4Print(sender: TObject; var Value: String);
begin
  Value := StrListUnidadesPAs.Values[Value];
end;

procedure TqrSicsDetail.QRDBText5Print(sender: TObject; var Value: String);
begin
   Value := StrListUnidadesFilas.Values[Value];
end;

procedure TqrSicsDetail.QRDBText1Print(sender: TObject; var Value: String);
begin
