...
type
  ...
  TfrmSicsGraphicsTotem = class(TfrmGraphicsBase)
     MesDS: TDataSource;
    DiaSmDS: TDataSource;
    DiaDS: TDataSource;
    HoraDS: TDataSource;
...
constructor TfrmSicsGraphicsTotem.Create(aOwer: TComponent);
begin
  inherited;

end;

procedure TfrmSicsGraphicsTotem.DefineCorChart;
begin
//BAH Não precisa usar aqui, foi mantido pq o formulario Base possui declaração que outros formularios usam
end;

procedure TfrmSicsGraphicsTotem.ExportarGrafico(const ExportarPara: TExportarPara);
var
  Chart: TDBChart;
begin
  inherited;
...
procedure TfrmSicsGraphicsTotem.FrameResize(Sender: TObject);
begin
  inherited;
...
procedure TfrmSicsGraphicsTotem.ExportarDadosExcel;
{$IFNDEF IS_MOBILE}
var
...
procedure TfrmSicsGraphicsTotem.SetGraficoSla(const Value: Boolean);
begin
...
procedure TfrmSicsGraphicsTotem.SetParamsSla(const Value: TParamsSla);
var
...
procedure TfrmSicsGraphicsTotem.SetVisible(const aValue: Boolean);
begin
  inherited;
  if aValue then
...
procedure TfrmSicsGraphicsTotem.SetVisibleGraphics;
begin
...
procedure TfrmSicsGraphicsTotem.QtdCheckBoxChange(Sender: TObject);
begin
...
procedure TfrmSicsGraphicsTotem.cdsMesCalcFields(DataSet: TDataSet);
begin
  cdsMesMesStr.AsString := String(MesStrArray[cdsMesMes.AsInteger]);
end;

procedure TfrmSicsGraphicsTotem.cdsDiaSmCalcFields(DataSet: TDataSet);
begin
  cdsDiaSmDiaSmStr.AsString := String(DiaSmStrArray[cdsDiaSmDiaSm.AsInteger]);
end;

procedure TfrmSicsGraphicsTotem.cdsAtendCalcFields(DataSet: TDataSet);
begin
  cdsAtendAtdRecNo.AsInteger := cdsAtend.RecNo;
end;

procedure TfrmSicsGraphicsTotem.cdsClienteCalcFields(DataSet: TDataSet);
begin
  cdsClienteClienteRecNo.AsInteger := cdsCliente.RecNo;
end;

procedure TfrmSicsGraphicsTotem.cdsGrAtendCalcFields(DataSet: TDataSet);
begin
  if (cdsGrAtend.RecNo > 0) and (cdsGrAtend.RecNo < 32000) then
    cdsGrAtendGrAtendRecNo.AsInteger := cdsGrAtend.RecNo;
end;

procedure TfrmSicsGraphicsTotem.cdsPACalcFields(DataSet: TDataSet);
begin
  cdsPAPARecNo.AsInteger := cdsPA.RecNo;
end;

procedure TfrmSicsGraphicsTotem.cdsGrPACalcFields(DataSet: TDataSet);
begin
  if (cdsGrPA.RecNo > 0) and (cdsGrPA.RecNo < 32000) then
    cdsGrPAGrPARecNo.AsInteger := cdsGrPA.RecNo;
end;

procedure TfrmSicsGraphicsTotem.cdsFaixaDeSenhaCalcFields(DataSet: TDataSet);
begin
  cdsFaixaDeSenhaFaixaDeSenhaRecNo.AsInteger := cdsFaixaDeSenha.RecNo;
end;

procedure TfrmSicsGraphicsTotem.cdsUnidadeCalcFields(DataSet: TDataSet);
begin
...
procedure TfrmSicsGraphicsTotem.cdsUnidadeUnidadeNomeGetText(Sender: TField; var Text: String; DisplayText: Boolean);
begin
  Text := dmUnidades.Nome[cdsUnidadeUnidade.AsInteger];
end;

procedure TfrmSicsGraphicsTotem.cboChartTypeChange(Sender: TObject);
begin
...
procedure TfrmSicsGraphicsTotem.RotateCCWBtnClick(Sender: TObject);
begin
  RotacionarPie((dbPieChartTmeTma.Series[0] as TPieSeries), False);
end;

procedure TfrmSicsGraphicsTotem.RotateCWBtnClick(Sender: TObject);
begin
  RotacionarPie((dbPieChartTmeTma.Series[0] as TPieSeries), True);
end;

procedure TfrmSicsGraphicsTotem.QtdEspAtdComboChange(Sender: TObject);
begin
...
procedure TfrmSicsGraphicsTotem.actImprimirExecute(Sender: TObject);
{$IFDEF SuportaQuickRep}
var
  DS: TDataSet;
...
procedure TfrmSicsGraphicsTotem.AjustaTipoDBChart;
begin
...
procedure TfrmSicsGraphicsTotem.AtendDSDataChange(Sender: TObject; Field: TField);
begin
  inherited;
...
procedure TfrmSicsGraphicsTotem.actFecharExecute(Sender: TObject);
begin
  inherited;
  Exit;
...
procedure TfrmSicsGraphicsTotem.btnFecharClick(Sender: TObject);
begin
  inherited;
  //
end;

procedure TfrmSicsGraphicsTotem.cdsMesTestesCalcFields(DataSet: TDataSet);
begin
...
procedure TfrmSicsGraphicsTotem.cdsMesTMEGetText(Sender: TField; var Text: String; DisplayText: Boolean);
begin
  Text := MyFormatDateTime('[h]:nn:ss', Sender.AsDateTime);
end;

procedure TfrmSicsGraphicsTotem.cdsTagCalcFields(DataSet: TDataSet);
begin
  cdsTagTagRecNo.AsInteger := cdsTag.RecNo;
end;

procedure TfrmSicsGraphicsTotem.CalcularEstatisticas;
...
procedure TfrmSicsGraphicsTotem.CalcularEstatisticasSla;
...
procedure TfrmSicsGraphicsTotem.chkSlaCinzaChange(Sender: TObject);
begin
  inherited;
...
procedure TfrmSicsGraphicsTotem.chkSlaEsperaChange(Sender: TObject);
begin
  inherited;
...
procedure TfrmSicsGraphicsTotem.chkSlaAtendimentoChange(Sender: TObject);
begin
  inherited;
...
procedure TfrmSicsGraphicsTotem.dbChartSlaMouseMove(Sender: TObject;
...
destructor TfrmSicsGraphicsTotem.Destroy;
begin
  cdsMes.Close;
  cdsDia.Close;
  cdsDiaSm.Close;
...
procedure TfrmSicsGraphicsTotem.PageControlGridsChange(Sender: TObject);
  ...
  begin
    case PageControlGrids.TabIndex of
      ...
      06: DS := cdsPASla;
      07: DS := cdsGrPASla;
      08: DS := cdsFilaEsperaSla;
      09: DS := cdsFaixaDeSenhaSla;
      10: DS := cdsTagSla;
      11: DS := cdsUnidadeSla;
    else
      DS := nil;
...
procedure TfrmSicsGraphicsTotem.PrepararLkpsUnidades;
var
  LfrmPesquisaRelatorio: TfrmPesquisaRelatorio;
...
procedure TfrmSicsGraphicsTotem.cdsMesAfterOpen(DataSet: TDataSet);
begin
  with DataSet do
  begin
...
procedure TfrmSicsGraphicsTotem.cdsTagTagNomeGetText(Sender: TField; var Text: String; DisplayText: Boolean);
begin
...
procedure TfrmSicsGraphicsTotem.StringField20GetText(Sender: TField; var Text: String; DisplayText: Boolean);
begin
...
procedure TfrmSicsGraphicsTotem.cdsFilaEsperaCalcFields(DataSet: TDataSet);
begin
  cdsFilaEsperaFilaEsperaRecNo.AsInteger := cdsFilaEspera.RecNo;
end;

procedure TfrmSicsGraphicsTotem.cdsFilaEsperaFilaEsperaNomeGetText(Sender: TField; var Text: String; DisplayText: Boolean);
begin
  if Sender.IsNull then
    Text := '(nenhuma)'
  else
...
procedure TfrmSicsGraphicsTotem.StringField22GetText(Sender: TField; var Text: String; DisplayText: Boolean);
begin
  if Sender.AsString = '' then
    Text := '(nenhuma)'
  else
...
procedure TfrmSicsGraphicsTotem.ComponentesCallCenter;
begin
  lblSenha.Text                 := 'Mesas';
